...
const HeroContent = () => {
  return (
    <div className="relative ml-[-10%]">
      {' '}
      {/* Further shifted the entire content to the left */}
      {/* Content Section */}
      <FadeUpAnimation className="relative z-10 grid grid-cols-12 items-center max-lg:gap-y-10">
        <div className="col-span-12 md:col-span-6">
          <p className="mb-7 text-base font-medium uppercase max-lg:mb-3">Welcome to the Future of Innovation</p>
          <h1 className="mb-10 text-4xl font-extrabold text-gray-800 dark:text-white max-md:mb-7 md:text-5xl">
            Discover how <span className="text-6xl text-red-500">Castrum Legions</span> transforms your digital
            experiences.
          </h1>
