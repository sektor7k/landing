      ...
      <div className="container relative mx-auto flex h-screen items-center justify-center">
        ...
        <motion.div
          ...
          <CardSpotlight className="h-64 w-64">
            <p className="relative z-20 mt-2 text-xl font-bold text-white">Wallets</p>
        ...
        <motion.div
          ...
          <CardSpotlight className="h-64 w-64">
            <p className="relative z-20 mt-2 text-xl font-bold text-white">Crypto Lending</p>
            <div className="relative z-20 mt-4 text-neutral-200">
              <ul>
                <Step title="Blockfi" />
        ...
        <motion.div
          ...
          variants={fadeFromLeftAnimation}>
          <CardSpotlight className="h-64 w-64">
            <p className="relative z-20 mt-2 text-xl font-bold text-white">Exchanges</p>
            <div className="relative z-20 mt-4 text-neutral-200">
              <ul>
                <Step title="Uniswap" />
        ...
        <motion.div
          ...
          variants={fadeFromRightAnimation}>
          <CardSpotlight className="h-64 w-64">
            <p className="relative z-20 mt-2 text-xl font-bold text-white">Payment Services</p>
            <div className="relative z-20 mt-4 text-neutral-200">
              <ul>
                <Step title="BitPay" />
                <Step title="CoinGate" />
