      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-neutral-800 dark:text-neutral-300 md:text-base">
            The Castrum platform will launch with its tournament system. The focus will be on engaging gameplay,
            integrating communities, and balancing features for esports enthusiasts.
          </p>
          <p className="mb-8 text-sm font-normal text-neutral-800 dark:text-neutral-300 md:text-base">
            A tournament-based ranking system will be introduced, allowing users to showcase their performance.
          </p>
          <p className="mb-8 text-sm font-normal text-neutral-800 dark:text-neutral-300 md:text-base">
            A profile system will launch to allow users to track their achievements, history, and community
            interactions.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-neutral-800 dark:text-neutral-300 md:text-base">
            A trading system will be integrated for players to exchange in-game items and currencies, aligning with the
            Castrum ecosystem.
          </p>
          <p className="mb-8 text-sm font-normal text-neutral-800 dark:text-neutral-300 md:text-base">
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-neutral-800 dark:text-neutral-300 md:text-base">
            Enhanced community support: The platform will include forums, interactive spaces, and better tools for
            player engagement.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-neutral-800 dark:text-neutral-300 md:text-base">
            The platform transitions to a DAO (Decentralized Autonomous Organization) system, ensuring community-driven
